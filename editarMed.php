                ...
                <p><a style="text-decoration: underline" href="cad.php">Funções</a> &raquo; <a style="text-decoration: underline" href="gerenciaH.php">Gerenciar</a> &raquo; 
					...
					<h2 class="title-style-2">Cliente <span class="title-under"></span></h2>
						...
						<table class="table table-style-1 table-bordered">
					      ...
					      <tbody>
                                                <tr>
                                                    <td style="text-align:center;"><input type="text" name="IDCLIENTE" size="1px" value="<?= $idcliente ?>" class="form-control" readonly></td>
                                                    <td style="text-align:center;"><input type="text" name="NM" size="5px" value="<?= $nm ?>" class="form-control" readonly></td>
                                                </tr>
					      </tbody>
					    </table>
                                            </div>                                            
					...
					<h2 class="title-style-2">Medidas <span class="title-under"></span></h2>
						...
						<table class="table table-style-1 table-bordered">
					      ...
					      <tbody>
                                                <tr>
                                                    <td style="text-align:center;"><input type="text" name="IDMEDIDA" pattern="([0-9]{1,4})" value="<?= $idmedida ?>" maxlength="4" class="form-control" placeholder="" readonly></td>
						...
						<table class="table table-style-1 table-bordered">
					      ...
					      <tbody>
                                                <tr>
                                                    <td style="text-align:center;"><input type="text" name="OBS" value="<?= $obs ?>" maxlength="100" class="form-control"/></td>
                                                </tr>
					      </tbody>
					    </table>
                                            </div>
