...
<html class="no-js">
    <head>
        ...
        <script type="text/javascript">
            function envio(){
if (confirm('Tem certeza que deseja excluir a conta selecionada?')) {
	return true;
} else {
	return false;
}
    ...
    <body>
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">Excluir Conta <span class="title-under"></span></h1>
			<p class="page-description">
				Deseja mesmo apagar a conta selecionada?
			</p>			
		</div>
	</div>
            <div class="container">
...
<?php include("../../fix/welcome.php"); ?>
                ...
                <p><a style="text-decoration: underline" href="../home.php">Funções</a> &raquo; <a style="text-decoration: underline" href="../gerencia.php">Gerenciar</a> &raquo; 
                    <b><a style="text-decoration: underline" href="manageAcc.php">Conta de acesso</a></b></p>
            </div>
        				<div class="main-container">
                                            <div class="container"> 
                                            <div class="col-md-6">
                                                <form action="deleteAcc.php" method="post">
					<h2 class="title-style-2">Excluir conta? <span class="title-under"></span></h2>
                        ...
                        <td style="text-align:center;"><input style="text-align:center;" type="text" name="USU" value="<?= $usu ?>" readonly></td>
                        </tr>
                        </tbody>
                        </table>                        
                                        <input type="submit" class="btn btn-danger pull-left" value="Excluir" oncLick="return envio();">
			<a href="manageAcc.php" class="btn btn-default pull-right">Cancelar</a>
                                                </form>
                                            </div>
                                            </div>
                                        </div>
