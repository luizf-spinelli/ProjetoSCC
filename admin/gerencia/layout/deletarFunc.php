...
if (confirm('Tem certeza que deseja excluir o funcionário selecionado?')) {
    ...
    <body>
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">Excluir Funcionário <span class="title-under"></span></h1>
			<p class="page-description">
				Deseja mesmo apagar o funcionário selecionado?
			</p>			
		</div>
	</div>
            <div class="container">
...
<?php include("../../fix/welcome.php"); ?>
                ...
                <p><a style="text-decoration: underline" href="../home.php">Funções</a> &raquo; <a style="text-decoration: underline" href="../gerencia.php">Gerenciar</a> &raquo; 
					...
					<h2 class="title-style-2">Excluir funcionário? <span class="title-under"></span></h2>
					      ...
					      <thead>
					        <tr>
					          ...
					          <th style="text-align:center;">Nome</th>
                                              ...
                                              <tbody>
                                                  <tr>
                        <td style="text-align:center;"><input style="text-align:center;" type="text" name="REG" value="<?= $reg ?>" readonly></td>
                        <td style="text-align:center;"><input style="text-align:center;" type="text" name="NOM" value="<?= $nom ?>" readonly></td>
                        </tr>
                        </tbody>
                        </table>                        
                                        <input type="submit" class="btn btn-danger pull-left" value="Excluir" oncLick="return envio();">
			<a href="manageFunc.php" class="btn btn-default pull-right">Cancelar</a>
                                                </form>
                                            </div>
                                            </div>
                                        </div>
