...
<?php include("../../fix/header.php"); ?>
    ...
    <body>
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">Gerenciar Serviços <span class="title-under"></span></h1>
			<p class="page-description">
				Listados abaixo, todos os serviços cadastrados.
			</p>			
		</div>
	</div>
            <div class="container">
...
<?php include("../../fix/welcome.php"); ?>
                ...
                <p><a style="text-decoration: underline" href="../home.php">Funções</a> &raquo; <a style="text-decoration: underline" href="../gerencia.php">Gerenciar</a> &raquo; 
                    <b><a style="text-decoration: underline" href="manageServ.php">Serviços</a></b></p>
            </div>
					...
					<h2 class="title-style-2">Serviços <span class="title-under"></span></h2>
						...
						<table class="table table-style-1 sortable">
					      ...
					      <tbody>
                                                    <?php
                                                      foreach($dadosserv as $i=>$v) {
                                                        echo "<tr>";
                                                        foreach ($v as $i2 => $v2) {
                                                          echo "<td style='text-align:center;'>$v2</td>";
                                                        }
                                                        echo "<td style='text-align:center;'><a  class='btn btn-success' href='editServ.php?idserv={$v[0]}'><i class='fa fa-pencil-square-o'></i></a></td>";
                                                        echo "<td style='text-align:center;'><a  class='btn btn-danger' href='deleteServ.php?idserv={$v[0]}&tp={$v[1]}'><i class='fa fa-remove'></i></a></td>";                                                        
                                                      }
                                                    ?>
					      </tbody>
					    </table>
