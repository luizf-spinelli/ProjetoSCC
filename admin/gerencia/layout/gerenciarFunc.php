...
<?php include("../../fix/header.php"); ?>
    ...
    <body>
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">Gerenciar Funcionários <span class="title-under"></span></h1>
			<p class="page-description">
				Listados abaixo, todos os funcionários cadastrados.
			</p>			
		</div>
	</div>
            <div class="container">
...
<?php include("../../fix/welcome.php"); ?>
                ...
                <p><a style="text-decoration: underline" href="../home.php">Funções</a> &raquo; <a style="text-decoration: underline" href="../gerencia.php">Gerenciar</a> &raquo; 
                    <b><a style="text-decoration: underline" href="manageFunc.php">Funcionários</a></b></p>
            </div>
        				<div class="main-container">
                                            <div class="container">                                            
                                            <div class="table-responsive col-md-12 col-sm-12">

					<h2 class="title-style-2">Funcionários <span class="title-under"></span></h2>
