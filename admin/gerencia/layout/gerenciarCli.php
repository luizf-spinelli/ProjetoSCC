					      ...
					      <tbody>
                                                    <?php
                                                      foreach($dados as $i=>$v) {
                                                        ...
                                                        echo "<td style='text-align:center;'><a  class='btn btn-info' href='detailsCli.php?idcliente={$v[0]}'><i class='fa fa-user'></i></a></td>";
                                                        echo "<td style='text-align:center;'><a target='_blank' class='btn btn-default' href='pdfCli.php?idcliente={$v[0]}'><i class='fa fa-file-pdf-o'></i></a></td>";
                                                        echo "<td style='text-align:center;'><a  class='btn btn-success' href='editCli.php?idcliente={$v[0]}'><i class='fa fa-pencil-square-o'></i></a></td>";
                                                        echo "<td style='text-align:center;'><a  class='btn btn-danger' href='deleteCli.php?idcliente={$v[0]}&nm={$v[1]}'><i class='fa fa-remove'></i></a></td>";                                                        
                                                      }
                                                    ?>
					      </tbody>
					    </table>
