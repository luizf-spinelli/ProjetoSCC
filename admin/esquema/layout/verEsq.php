    ...
    <body>
		...
		<div class="container zoomIn animated">
			...
			<p class="page-description">
				Listado abaixo, o esquema selecionado.
			</p>			
		</div>
	</div>
            <div class="container">
...
<?php include("../../fix/welcome.php"); ?>
                ...
                <p><a style="text-decoration: underline" href="../home.php">Funções</a> &raquo; 
                    <b><a style="text-decoration: underline" href="manageEsq.php">Esquema</a></b></p>
            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="container">
                                                    ...
                                                    <div class="form-group">
                                                        <a href="manageEsq.php" class="btn btn-default">&larr; Voltar</a>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div><br/>
