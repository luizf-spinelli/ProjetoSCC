...
<?php include("./fix/public-header.php"); ?>
	...
	<div class="main-container">
		...
		<div class="container">
			...
			<div class="row fadeIn animated section-home home-reasons">

				<div class="col-md-6 col-sm-12">

					<img src="assets/images/logo.bmp" alt="" class="img-responsive">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="reasons-col animate-onscroll fadeIn">
                        ...
                        <img src="assets/images/reasons/sobre-1.jpg" alt="">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="reasons-col animate-onscroll fadeIn">
                        ...
                        <img src="assets/images/reasons/sobre-2.jpg" alt="">
